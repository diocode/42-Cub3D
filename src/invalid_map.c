...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/04/01 12:56:43 by digoncal          #+#    #+#             */
/*   Updated: 2024/04/02 11:55:55 by digoncal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/cub3d.h"

static bool	invalid_map_elemets(char const *str)
{
	int	i;
